...
echo "begin copy ruoyi-modules-project "
cp ../ruoyi-modules/ruoyi-project/target/ruoyi-modules-project.jar ./ruoyi/modules/project/jar

echo "begin copy ruoyi-modules-library "
cp ../ruoyi-modules/ruoyi-library/target/ruoyi-modules-library.jar ./ruoyi/modules/library/jar
